...
BEGIN Scenario
    Name            gaofen_coverage

BEGIN Epoch
    Epoch        20 Sep 2016 04:00:00.000000

END Epoch

BEGIN Interval

Start                   20 Sep 2016 04:00:00.000000000
Stop                    21 Sep 2016 04:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          20 Sep 2016 04:00:00.000000000
    EndTime            21 Sep 2016 04:00:00.000000000
    CurrentTime        20 Sep 2016 04:00:00.000000000
    Direction          Forward
...
BEGIN References
    Instance *
        *
        Chain/Chain1
        Constellation/4Gaofen_Cons1
        Constellation/fac_Cons2
        CoverageDefinition/GlobalCov
        Facility/Beijing/Receiver/Beijing_rcv
        Facility/Kashi/Receiver/Kashi_rcv
        Facility/Mudanjiang/Receiver/Mudanjiang_rcv
        Facility/Qingdao/Receiver/Qingdao_rcv
        Facility/Sanya/Receiver/Sanya_rcv
        Satellite/Gaofen1/Transmitter/g1_Trans
        Satellite/Gaofen2/Transmitter/g2_Trans
        Satellite/Gaofen4/Transmitter/g4_Trans
        Satellite/Gaofen8/Transmitter/g8_Trans
        Satellite/Gaofen9/Transmitter/g9_Trans
    END Instance
    Instance Chain/Chain1
    END Instance
    Instance Constellation/4Gaofen_Cons1
        Chain/Chain1
        CoverageDefinition/GlobalCov
    END Instance
    Instance Constellation/fac_Cons2
        Chain/Chain1
    END Instance
    Instance CoverageDefinition/GlobalCov
    END Instance
    Instance Facility/Beijing
        Constellation/fac_Cons2
        Facility/Beijing
        Facility/Beijing/Receiver/Beijing_rcv
    END Instance
    Instance Facility/Beijing/Receiver/Beijing_rcv
        Constellation/fac_Cons2
    END Instance
    Instance Facility/Kashi
        Constellation/fac_Cons2
        Facility/Kashi
        Facility/Kashi/Receiver/Kashi_rcv
    END Instance
    Instance Facility/Kashi/Receiver/Kashi_rcv
        Constellation/fac_Cons2
    END Instance
    Instance Facility/Mudanjiang
        Constellation/fac_Cons2
        Facility/Mudanjiang
        Facility/Mudanjiang/Receiver/Mudanjiang_rcv
    END Instance
    Instance Facility/Mudanjiang/Receiver/Mudanjiang_rcv
        Constellation/fac_Cons2
    END Instance
    Instance Facility/Qingdao
        Constellation/fac_Cons2
        Facility/Qingdao
        Facility/Qingdao/Receiver/Qingdao_rcv
    END Instance
    Instance Facility/Qingdao/Receiver/Qingdao_rcv
        Constellation/fac_Cons2
    END Instance
    Instance Facility/Sanya
        Constellation/fac_Cons2
        Facility/Sanya
        Facility/Sanya/Receiver/Sanya_rcv
    END Instance
    Instance Facility/Sanya/Receiver/Sanya_rcv
        Constellation/fac_Cons2
    END Instance
    Instance Satellite/Gaofen1
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen1
        Satellite/Gaofen1/Sensor/Sensor1
        Satellite/Gaofen1/Transmitter/g1_Trans
    END Instance
    Instance Satellite/Gaofen1/Sensor/Sensor1
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen1/Sensor/Sensor1
    END Instance
    Instance Satellite/Gaofen1/Transmitter/g1_Trans
        Constellation/4Gaofen_Cons1
        CoverageDefinition/GlobalCov
    END Instance
    Instance Satellite/Gaofen2
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen2
        Satellite/Gaofen2/Sensor/Sensor2
        Satellite/Gaofen2/Transmitter/g2_Trans
    END Instance
    Instance Satellite/Gaofen2/Sensor/Sensor2
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen2/Sensor/Sensor2
    END Instance
    Instance Satellite/Gaofen2/Transmitter/g2_Trans
        Constellation/4Gaofen_Cons1
        CoverageDefinition/GlobalCov
    END Instance
    Instance Satellite/Gaofen4
        Satellite/Gaofen4
        Satellite/Gaofen4/Sensor/Sensor3
        Satellite/Gaofen4/Transmitter/g4_Trans
    END Instance
    Instance Satellite/Gaofen4/Sensor/Sensor3
        Satellite/Gaofen4/Sensor/Sensor3
    END Instance
    Instance Satellite/Gaofen4/Transmitter/g4_Trans
    END Instance
    Instance Satellite/Gaofen8
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen8
        Satellite/Gaofen8/Sensor/Sensor4
        Satellite/Gaofen8/Transmitter/g8_Trans
    END Instance
    Instance Satellite/Gaofen8/Sensor/Sensor4
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen8/Sensor/Sensor4
    END Instance
    Instance Satellite/Gaofen8/Transmitter/g8_Trans
        Constellation/4Gaofen_Cons1
        CoverageDefinition/GlobalCov
    END Instance
    Instance Satellite/Gaofen9
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen9
        Satellite/Gaofen9/Sensor/Sensor5
        Satellite/Gaofen9/Transmitter/g9_Trans
    END Instance
    Instance Satellite/Gaofen9/Sensor/Sensor5
        Constellation/4Gaofen_Cons1
        Satellite/Gaofen9/Sensor/Sensor5
    END Instance
    Instance Satellite/Gaofen9/Transmitter/g9_Trans
        Constellation/4Gaofen_Cons1
        CoverageDefinition/GlobalCov
    END Instance
END References
